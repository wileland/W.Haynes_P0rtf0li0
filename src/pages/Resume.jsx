  ...
  return (
    <main className="resume-section">
      <header className="resume-header">
        <h2>My Resume</h2>
        <p>Download my resume to learn more about my professional background and skills.</p>
        <a href={resumeFile} download="William-Haynes-Resume.pdf">Download Resume</a>
      </header>
      <div className="resume-content">
        <img src={resumeImage} alt="William Haynes" className="resume-image" />
        <section className="professional-summary">
          <h3>Professional Summary</h3>
          <p>Seasoned educator transitioning into the tech industry as a dynamic Full Stack Web Developer...</p>
        </section>
        {/* Education, Technical Skills, Professional Experience, Personal Projects */}
        <h3>Education</h3>
        <ul>
          <li>
